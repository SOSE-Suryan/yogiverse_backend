    ...
    def get(self, request, id=None, format=None):
        ...
        if request.user.is_authenticated:
            ...
            if is_user.exists() :
                ...
                if search_chat:
                    chat_data = ChatModel.objects.filter(group_name__icontains=search_chat,members__in= is_user)
                ...
                chat_data  = ChatModel.objects.filter(members__in=is_user).order_by('-id')
                ch_data = list()
